<!--
 * @Author: your name
 * @Date: 2020-10-18 22:05:49
 * @LastEditTime: 2020-10-18 22:35:05
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \starbks\src\components\adSlider.vue
-->
<template>
  <section class="slider-ad">
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="item in sliderList" :key="item">
          <a href="javascript:;">
            <img
              :src="'/static/images/featured/2019spring/' + item.sliderImage"
              class="tablet-show mobile-hidden"
            />
            <img
              :src="
                '/static/images/featured/2019spring/' + item.sliderImageMobile
              "
