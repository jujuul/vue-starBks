  ...
  <section class="body">
    <div class="menu-list">
      <ul>
        ...
        <li><hr /></li>
        <li>
          <a href="javascript:;" class="apps-overlay"> 星巴克移动应用 </a>
        </li>
        <li>
          <a href="javascript:;" class="svc-overlay"> 星礼卡 </a>
        </li>
        <li>
        ...
        <li>
          <a href="javascript:;" class="coffeehouse-overlay"> 咖啡星讲堂 </a>
        </li>
        <li>
          <a href="javascript:;" class="roastery-overlay"> 上海烘焙工坊 </a>
        </li>
        <li>
          <a href="javascript:;" class="about-overlay"> 关于星巴克 </a>
        </li>
        <li>
          <a href="javascript:;" class="help-overlay"> 帮助中心 </a>
        </li>
        <li><hr /></li>
      </ul>
